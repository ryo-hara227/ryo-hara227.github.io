    ...
    warningPages: [
      ...
      },
      {
        paragraphs: pg(`
          ...
          これから始まるのは「ただの誰かの」物語。しかし、これは「皆様全員にとっての」物語でもあります。1人でも多くの方の力でその誰かのことを助けてあげてください。
...

      {
        ...
        sections:[
          ...
          },
          {
            ...
            groupHints:[
              "『透明な付箋』は5曲、『青を生きる』は6曲収録されています。",
              "6 - 5 + 3 = 4、5 + 6 - 1 = 10 です。4はそのまま、10は漢数字の「十」に直してみましょう。",
              "「4」と「十」を縦に並べて重ねると、方位記号が作れます。これは後で使うようです。",
              "2枚の紙はメールの添付ファイルです。このヒントでも、①と②にはそれぞれのEPの曲数を入れればよいようです。",
              "解読のヒントは、1枚目の暗号の5行目と6行目にあるようです。2つの暗号では同じ操作をするようです。「矛先と逆にひとつ動け」の「矛先」とは何のことでしょうか。",
              "「矛先」は、1枚目のヒントで作った方位記号の先、つまり北の方向を指しています。その反対の南は下向きなので、何かの下を読めばよさそうです。",
              "メールの「灰被の足元」が大切です。灰被は文字通り、さっきまでいた地名も指しますが……「姫」をつけると「あの子」になりますよね？"
            ],
            items:[
